        ...
        public static void Main()
        {
            ...
            do
            {
                ...
                if (SplashKit.KeyTyped(KeyCode.SKey))
                {
                    ...
                    drawObject.Save("/Users/James/Downloads/Credit Task 5.2/Shapes.txt");
                ...
                if (SplashKit.KeyTyped(KeyCode.OKey))
                {
                    ...
                    try
                    {
                        drawObject.Load("/Users/James/Downloads/Credit Task 5.2/Shapes.txt");
                    }
                    catch (Exception e) 
                    {
